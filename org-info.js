...
}else{b.W.innerHTML=b.N.NAV+b.N.D.innerHTML;}b.N.hide();O.hE(document.body);if("?/toc/?"!=d){window.location.replace(b.BU+b.dT());
...
}else{O.hE(document.body);window.location.replace(b.BU+b.dT());window.scrollTo(0,0);
